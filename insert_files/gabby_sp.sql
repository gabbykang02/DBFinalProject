/*
Returns the month, year, and number of cases that occurred in @country
*/
...
/*
Returns type, average rating, number of pieces of media, and average run time of all pieces of film media released in @year
*/
...
/*
Return platform, number of games relased, average metascore rating of all games released in @month, @year
*/
...
/*
Returns all TwitchStats as well as CovidData stats for @country between @startMonth, @startYear and @stopMonth, @stopYear.

When paired with the UI, plots all statistics on the same plot over time as a line plot and plots each statistics as an interactive sunburst plot.
...
/*
Returns the month, year, and twitch stat as specified by @command. 

When paired with the UI, plots the specified twitch stat as an interactive sunburst plot.
*/
